...
def show_search_screen(stdscr):
    curses.curs_set(1)
    stdscr.addstr(1, 2, "Nome do artista: (Ctrl-G para pesquisar)")
...
def main(stdscr):
    ...
    albums_panel = Menu('Lista de albuns do artista selecionado',
                        (height, width, 0, 0))

    tracks_panel = Menu('Lista de musicas do album selecionado',
                        (height, width, 0, 0))
...
try:
    ...
    print('Obrigado por utilizar nosso aplicativo, até mais!')